package com.example.mobileappclient.ui.theme
...
//extension class for welcome screen background color
...
val ColorScheme.isInactiveIndicatorColor
    @Composable
    get() = if(isSystemInDarkTheme()) DarkGray else LightGray


val ColorScheme.buttonBackgroundColors
    @Composable
    get() = if(isSystemInDarkTheme()) Purple700 else Purple500
